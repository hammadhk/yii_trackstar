...
class Issue extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('type_id', 'in', 'range'=>self::getAllowedTypesRange()),
	...
	/**
	 * Retrives a list of issue type
	 * @return an array of available issue type
	 */
	...
	/**
	 * Retrives a list of issue statuses
	...
	/**
	 * Retrives a list of allowed issue types
	 * @return an array of allowed values of issue types
	 */
	public static function getAllowedTypesRange()
	{
		return array_keys(self::getTypeOptions());
	}
	
	/**
	 * Retrives a list of allowed issue statuses
	 * @return an array of allowed values of issue statuses
	 */
